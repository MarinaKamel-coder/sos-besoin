# HTTPS://github.com/MarinaKamel-coder/sos-besoin.git
...
- **PostgreSQL** (Neon)
- **Prisma ORM**
- **Clerk** (auth) _(prévu/intégration progressive)_
- **Stripe** (paiement) _(prévu/intégration progressive)_
...
1. Copier le fichier d’exemple :
   ...
   _(Sur Windows si `cp` ne fonctionne pas, copiez manuellement le fichier.)_
